...
const entryPoint = path.join(root, 'src', 'js', 'main.js');
...
async function build() {
  ...
  execSync('npx tailwindcss -i src/css/styles.css -o dist/styles.css --minify', {
    stdio: 'inherit',
  });
  ...
  // Run 11ty to generate HTML
  console.log('Building HTML with 11ty...');
  execSync('npx @11ty/eleventy --output=dist', {
    stdio: 'inherit',
  });

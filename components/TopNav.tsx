    ...
    >
      <Link href="/" className="flex items-center gap-2.5 no-underline">
        ...
        <span className="font-mono text-[15px] font-bold tracking-tight text-text-primary">
          Review<span style={{ color: 'var(--cyan)' }}>Radar</span>
        </span>
      </Link>
      <div className="flex-1" />
      <ul className="flex list-none gap-6" style={{ margin: 0, padding: 0 }}>
        <li>
          <Link href="/" className="text-[13px] no-underline transition-colors duration-150 hover:text-text-primary" style={{ color: linkColor }}>
            Home
          </Link>
        </li>
        <li>
          <Link href="/guide" className="text-[13px] no-underline transition-colors duration-150 hover:text-text-primary" style={{ color: linkColor }}>
            Guide
          </Link>
        </li>
      </ul>
      ...
      <button
        ...
        title={isLight ? 'Light mode — click for dark' : 'Dark mode — click for light'}
      >
        {isLight ? '☀️' : '🌙'}
      </button>
      <a

      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="rounded-xl border border-border-faint bg-surface p-5">
          ...
          <div className="flex flex-wrap gap-2.5">
            <a href={`https://wa.me/?text=${encodeURIComponent('Check out ReviewRadar - a GitHub PR dashboard: https://reviewradar.tech')}`}
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg px-[18px] py-[10px] text-[13px] font-medium no-underline"
            ...
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Check out ReviewRadar - a GitHub PR dashboard: https://reviewradar.tech')}`}
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg px-[18px] py-[10px] text-[13px] font-medium no-underline"
            ...
            <a href={`mailto:?subject=${encodeURIComponent('ReviewRadar - GitHub PR Dashboard')}&body=${encodeURIComponent('Check out ReviewRadar, a GitHub PR dashboard: https://reviewradar.tech')}`}
              className="inline-flex items-center gap-1.5 rounded-lg px-[18px] py-[10px] text-[13px] font-medium no-underline"
            ...
            <button onClick={() => { navigator.clipboard.writeText('https://reviewradar.tech'); }}
              className="inline-flex items-center gap-1.5 rounded-lg border border-border-faint bg-ink-mid px-[18px] py-[10px] text-[13px] font-medium text-text-primary no-underline">
        ...
        <a href="https://buymeacoffee.com/hannahredmond"
          className="inline-flex items-center gap-2 rounded-lg px-6 py-3 text-[15px] font-medium no-underline"

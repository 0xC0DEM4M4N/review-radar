    ...
    <>
      ...
      <div className="min-h-screen" style={{ paddingTop: 56 }}>
        ...
        <section className="mx-auto grid min-h-[calc(100vh-56px)] max-w-[1280px] grid-cols-2 items-center gap-0 px-12 pb-20 pt-[60px] max-lg:grid-cols-1 max-lg:text-center">
          <div className="pr-12 max-lg:pr-0">
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-cyan-mid bg-cyan-dim px-3.5 py-1 font-mono text-[11px] uppercase tracking-wider text-cyan animate-fade-up">
              <span className="h-1.5 w-1.5 rounded-full bg-cyan"></span> Free &amp; open source
            </div>
            <h1 className="mb-6 font-mono text-[clamp(36px,4vw,56px)] font-bold leading-tight tracking-tight text-text-primary animate-fade-up">
              Your PRs.<br /><span className="text-cyan">On radar.</span>
            </h1>
            <p className="mb-10 max-w-[440px] text-lg font-light leading-relaxed text-white/55 max-lg:mx-auto animate-fade-up">
              ReviewRadar gives you a live sweep of every open pull request across your repos — who&apos;s
              blocked, what needs attention, and what&apos;s ready to ship.
            </p>
            <div className="mb-12 flex flex-wrap items-center gap-3.5 animate-fade-up">
              ...
              <a className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-transparent px-6 py-3.5 text-sm text-white/60 no-underline transition-all duration-150 hover:border-white/35 hover:text-text-primary"
                href="https://github.com" target="_blank" rel="noopener noreferrer">View on GitHub</a>
            </div>
            <div className="flex gap-8 animate-fade-up">
              <div>
                <div className="font-mono text-2xl font-bold text-text-primary">∞</div>
                <div className="mt-0.5 text-xs text-white/40">Repos supported</div>
              </div>
              <div>
                <div className="font-mono text-2xl font-bold text-text-primary">0ms</div>
                <div className="mt-0.5 text-xs text-white/40">Setup time</div>
              </div>
              <div>
                <div className="font-mono text-2xl font-bold text-text-primary">100%</div>
                <div className="mt-0.5 text-xs text-white/40">Client-side</div>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-[1280px] border-t border-white/[0.06] px-12 py-[100px] max-md:px-5 max-md:py-[60px]" id="features">
          <div className="mb-4 font-mono text-[11px] uppercase tracking-widest text-cyan">Built for developers</div>
          <h2 className="mb-[60px] max-w-[500px] font-mono text-4xl font-bold leading-tight tracking-tight text-text-primary">
            Everything on the sweep.</h2>
          <div className="grid grid-cols-3 gap-6 max-lg:grid-cols-2 max-md:grid-cols-1">
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">Live radar sweeps</h3>
              <p className="text-sm leading-relaxed text-white/45">Auto-refresh on a configurable interval. Your PR list stays
                current without lifting a finger. Browser notifications for approvals, comments, and build changes.</p>
            </div>
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              <div className="mb-[18px] flex h-10 w-10 items-center justify-center rounded-[10px] border border-cyan-mid bg-cyan-dim">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">PR-aware filtering</h3>
              <p className="text-sm leading-relaxed text-white/45">Filter by all, mine, needs attention, approved, changes
                requested, pending, or conflicts. Click any label or status badge in the table to filter by that value instantly.</p>
            </div>
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              <div className="mb-[18px] flex h-10 w-10 items-center justify-center rounded-[10px] border border-cyan-mid bg-cyan-dim">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">Diff at a glance</h3>
              <p className="text-sm leading-relaxed text-white/45">Review status, build state, mentions, labels, merge
                conflicts, and last updated — all visible without leaving the dashboard.</p>
            </div>
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              <div className="mb-[18px] flex h-10 w-10 items-center justify-center rounded-[10px] border border-cyan-mid bg-cyan-dim">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">Attention scoring</h3>
              <p className="text-sm leading-relaxed text-white/45">PRs that need your eyes float to the top. Mentions, stale
                reviews, and failed builds are all factored in. Sort by any column.</p>
            </div>
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              <div className="mb-[18px] flex h-10 w-10 items-center justify-center rounded-[10px] border border-cyan-mid bg-cyan-dim">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">Zero backend</h3>
              <p className="text-sm leading-relaxed text-white/45">Runs entirely in your browser. Paste your GitHub PAT and go
                — nothing is ever stored server-side. Your token stays in localStorage only.</p>
            </div>
            <div className="rounded-2xl border border-border-faint bg-surface p-7 transition-all duration-200 hover:border-cyan/20 hover:bg-cyan/[0.03]">
              <div className="mb-[18px] flex h-10 w-10 items-center justify-center rounded-[10px] border border-cyan-mid bg-cyan-dim">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <h3 className="mb-2.5 font-mono text-sm font-bold text-text-primary">Multi-repo support</h3>
              <p className="text-sm leading-relaxed text-white/45">Sweep across as many repositories as you have access to.
                One dashboard, all your PRs. Or focus on a single repo when you need to.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-[1280px] border-t border-white/[0.06] px-12 py-[100px] max-md:px-5 max-md:py-[60px]" id="how-it-works">
          <h2 className="mb-4 font-mono text-4xl font-bold tracking-tight text-text-primary">How it works</h2>
          <p className="mb-12 text-lg text-white/45">Get started in 3 simple steps</p>
          <div className="flex max-w-[700px] flex-col gap-8">
            <div className="flex items-start gap-5">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-cyan-mid bg-cyan-dim font-mono text-base font-bold text-cyan">
                1</div>
              <div>
                <h3 className="mb-1.5 font-mono text-base font-bold text-text-primary">Create a GitHub Personal Access Token</h3>
                <p className="text-sm leading-relaxed text-white/45">Go to <a className="text-cyan no-underline hover:underline"
                  href="https://github.com/settings/tokens/new" target="_blank" rel="noopener noreferrer">GitHub Settings → Developer settings → Personal access tokens</a>. Create a token with <code className="rounded bg-white/[0.06] px-1.5 py-0.5 font-mono text-xs text-cyan">repo</code> scope for private repos or <code className="rounded bg-white/[0.06] px-1.5 py-0.5 font-mono text-xs text-cyan">public_repo</code> for public only.</p>
              </div>
            </div>
            <div className="flex items-start gap-5">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-cyan-mid bg-cyan-dim font-mono text-base font-bold text-cyan">
                2</div>
              <div>
                <h3 className="mb-1.5 font-mono text-base font-bold text-text-primary">Enter Your Token</h3>
                <p className="text-sm leading-relaxed text-white/45">Paste your token into the dashboard. It&apos;s stored locally
                  in your browser via localStorage and never sent to any server. The app calls GitHub&apos;s API directly from
                  your browser.</p>
              </div>
            </div>
            <div className="flex items-start gap-5">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-cyan-mid bg-cyan-dim font-mono text-base font-bold text-cyan">
                3</div>
              <div>
                <h3 className="mb-1.5 font-mono text-base font-bold text-text-primary">Start Tracking</h3>
                <p className="text-sm leading-relaxed text-white/45">Load all your PRs or specify a repository. Enable
                  auto-refresh and browser notifications to stay up to date. Filter, sort, and sweep across your code review
                  queue.</p>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-[1280px] px-12 pb-[100px] max-md:px-5 max-md:pb-[60px]">
          <div className="mb-4 font-mono text-[11px] uppercase tracking-widest text-cyan">See it in action</div>
          <h2 className="mb-10 font-mono text-4xl font-bold tracking-tight text-text-primary">Every PR. One view.</h2>
          <div className="overflow-hidden rounded-2xl border border-border-faint bg-surface">
            <div className="flex items-center gap-2 border-b border-white/[0.06] bg-ink-light/50 px-5 py-3.5">
              ...
              <span className="flex-1 text-center font-mono text-[11px] text-white/25">ReviewRadar — dashboard</span>
            </div>
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Pull request</th>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Author</th>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Status</th>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Reviews</th>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Build</th>
                  <th className="border-b border-white/[0.06] px-5 py-3 text-left font-mono text-[10px] uppercase tracking-widest text-white/25">Updated</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="border-t border-white/[0.06] px-12 py-20 text-center max-md:px-5 max-md:py-[60px]">
          <h2 className="mb-4 font-mono text-[42px] font-bold leading-tight tracking-tight text-text-primary max-md:text-[28px]">
            Get on <span className="text-cyan">radar.</span></h2>
          <p className="mb-9 text-base text-white/40">No account. No install. Just your GitHub PAT and a browser tab.</p>
          <Link href="/dashboard"
            className="inline-flex items-center gap-1.5 rounded-full border-none bg-cyan px-7 py-3.5 font-mono text-[13px] font-bold text-ink-light no-underline transition-all duration-150 hover:-translate-y-px hover:opacity-90">
            Open ReviewRadar →
          </Link>
